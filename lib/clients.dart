...
class _ClientsState extends State<Clients> {
  final studentListKey = GlobalKey<_ClientsState>();
  List listeClt=[];
  String searchString="";
                                            ...
                                            Expanded(
                                              ...
                                              Column(
                                                ...
                                                children: <Widget>[
                                                  Container(height: 5),
                                                  Text(
                                                    filteredData[index]['nom'] +
                                                        ' ' + filteredData[index]['prenom'],
                                                    style: MyTextSample.title(
                                                        context)!.copyWith(
                                                      color: const Color(
                                                          0xFF37474F),
                                                    ),
